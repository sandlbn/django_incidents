# -*- coding: utf-8 -*-
"""
Django settings for django_incidents project.
...
if DEBUG:
    ...
    DEFAULT_FROM_EMAIL = environ.get('DEFAULT_FROM_EMAIL',
            'django_incidents <django_incidents-noreply@>')
    EMAIL_BACKEND = 'django.core.mail.backends.smtp.EmailBackend'
    EMAIL_HOST = environ.get('EMAIL_HOST', 'smtp.sendgrid.com')
    EMAIL_HOST_PASSWORD = os.environ.get('SENDGRID_PASSWORD', '')
    EMAIL_HOST_USER = os.environ.get('SENDGRID_USERNAME', '')
    EMAIL_PORT = environ.get('EMAIL_PORT', 587)
    EMAIL_SUBJECT_PREFIX = environ.get('EMAIL_SUBJECT_PREFIX', '[django_incidents] ')
    EMAIL_USE_TLS = True
